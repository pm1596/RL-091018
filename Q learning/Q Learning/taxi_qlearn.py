...
# maximum steps in an episode, 200 for Taxi-v2
...
# Learning rate : update Q table each step by start_alpha
START_ALPHA = 0.1

# adaptive learning rate adjusted in each update
ALPHA_TAPER = 0.01
...
# keep track of how many times each Q(s,a) is updated
